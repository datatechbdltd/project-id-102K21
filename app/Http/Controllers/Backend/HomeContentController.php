...
class HomeContentController extends Controller
{
        ...
        if ($request->ajax()){
            ...
            return datatables::of($data)
                ->addColumn('faq', function($data) {
                    ...
                    return '<a href="'.route('backend.homeContent.edit', $data).'" class="btn btn-info"><i class="fa fa-edit"></i> </a>
                    <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('backend.homeContent.destroy', $data).'"><i class="fa fa-trash"></i> </button>';
                })
                ->rawColumns(['faq','status','image','action'])
                ->make(true);
        }else{
            return view('backend.website.home-content.index');
        }
    }
    ...
    {
        return view('backend.website.home-content.create');
    }
    ...
    {
        return view('backend.website.home-content.edit', compact('homeContent'));
    }
