...
class CallToActionController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return datatables::of($data)
                ...
                ->addColumn('action', function($data) {
                    return '<a href="'.route('backend.callToAction.edit', $data).'" class="btn btn-info"><i class="fas fa-edit"></i> </a>
                   <button class="btn btn-danger" onclick="delete_function(this)" value="'.route('backend.callToAction.destroy', $data).'"><i class="fas fa-trash"></i> </button>';
                })
                ->rawColumns(['action_name', 'status', 'action'])
                ->make(true);
        } else {
            return view('backend.website.call-to-action.index');
        }
    }
    ...
    {
        return view('backend.website.call-to-action.create');
    }
    ...
    {
        return view('backend.website.call-to-action.edit', compact('callToAction'));
    }
