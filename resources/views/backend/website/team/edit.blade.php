    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('backend.team.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Back to list</a>
            </div>
        </div>
    </div>
@endsection
  ...
  <div class="contentbar">
    ...
    <div class="row">
        <div class="card m-b-30 col-12 ">
            ...
            <div class="card-body">
                <form class="row justify-content-center" method="POST" action="{{ route('backend.team.update', $team) }}"
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input name="image" type="file" class="form-control" id="image" value="{{ $team->image }}">
                            </div>
                        </div>
                        <div class="form-group row">
