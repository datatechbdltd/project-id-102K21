                ...
                <form class="row justify-content-center" method="POST" action="{{ route('backend.portfolio.update', $portfolio) }}"
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input name="icon" type="text" class="form-control" id="icon" value=" {{ $portfolio->icon }}">
                                @error('icon')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <textarea name="description" type="text" class="form-control" id="description">{{ $portfolio->description }}</textarea>
                                @error('description')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
